...
export default function EditInvoiceForm({
  ...
  const updateInvoiceBindId = updateInvoice.bind(null, invoice.id);
  const initialState: State = { message: null, errors: {} };
  const [state, formAction] = useActionState(updateInvoiceBindId, initialState);
  return (
            ...
            <div className='flex gap-4'>
              <div className='flex items-center'>
                <input
                  ...
                  className='border-gray-300 bg-gray-100 w-4 h-4 text-gray-600 cursor-pointer focus:ring-2'
                />
                <label
                  htmlFor='pending'
